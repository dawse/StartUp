        ...
        <div className="relative z-1 mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] py-22.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark xl:py-27.5">
          ...
          >
            ...
            <p className="mx-auto lg:w-11/12">
              Nous accompagnons entreprises et startups en leur fournissant des solutions digitales performantes et adaptées à leurs besoins. Nos clients, en Tunisie et à l'international, bénéficient d’un savoir-faire unique et d’une expertise éprouvée.
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Projets réalisés</p>
            </motion.div>
            <motion.div
              variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}
              initial="hidden"
